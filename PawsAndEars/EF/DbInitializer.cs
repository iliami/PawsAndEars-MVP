...
namespace PawsAndEars.EF
{
    public class DbInitializer : DropCreateDatabaseAlways<AppDbContext>
    {
        protected override void Seed(AppDbContext context)
        {
            ...
            {
                new Dog() { Id = 1, Name = "A", User = user, UserId = 1, Age = 12, Breed = "A", Length = 100, Weight = 10 }
            ,   new Dog() { Id = 2, Name = "AA", User = user, UserId = 1, Age = 24, Breed = "AA", Length = 150, Weight = 15, Diseases = new List<Disease>() { disease } }
            };
